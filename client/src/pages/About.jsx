    ...
    <div className="w-full flex justify-center">
      <div className="w-[90%] max-w-2xl rounded-xl shadow-xl p-3 flex flex-col gap-3">
        ...
        <div className="w-max flex flex-col">
          ...
          <h1 className="text-xl font-semibold text-center">Ritik Dangi</h1>
        </div>
        <ul className="list-disc w-max mx-5">
          ...
          <li className="hover:underline hover:text-blue-600 cursor-pointer">
            <a
              className="flex items-center gap-2"
              href="
https://www.linkedin.com/in/ritik-dangi-8a1729171?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app"
              target="_blank"
            >
